                ...
                <div class="container-fluid">    
                  <div class="row">
                    <?php foreach ($loker as $key) { ?>
                      <?php if($key->idl == 0){ ?>
                        <h3 align="center">Tidak Ada lowongan yang sesuai dengan berkas yang anda unggah</h3>
                        <br>
                        <a href="<?php echo site_url(); echo "/pelamar/ubah/"; echo $idku ;  ?>" align="center"> <button class="btn-link" align="center">Kembali</button></a>
                      <?php }else{ 
                      ?>
                        <?php $maque = $this->db->query("SELECT count(id_karyawan) as slsh from karyawan where id_profesi = '$key->id_profesi' AND id_status = 'Pelamar'");//cari banyak orang yang milih
                        $selisih = $maque->row(); ?>
                          ...
                          <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                            ...
                            <div class="student-inner-std res-mg-b-30"  style="background-color: #e6f2ff">                        
                              <div class="student-dtl">                          
                                ...
                                <?php if ($key->kuota-$selisih->slsh != 0) { //jika kuota masih ada
                                  if ( date('y-m-d') <= date('y-m-d', strtotime($key->akhir))) { //jika lowongan masih aktif?> 
                            ...
                            <br><a href="<?php echo site_url(); echo "/pelamar/ubah/"; echo $idku ;  ?>"> <button class='btn-link' align="center">Kembali</button></a>
                          </div>   
                        <?php } ?>
                    <?php 
                    } ?>
