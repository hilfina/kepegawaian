                  ...
                  <?php foreach ($datasaya as $key) {?>
                    <tr>
                      <td colspan="2" style="padding: 10px;">
                        <img src="<?=base_url()?>assets/login/images/logo.png" style="width: 70px">
                        <b style="font-size: 24px; font-family: merriweather, serif; "> Rumah Sakit Islam Aisyiyah Malang</b>
                      </td>
                    </tr>
                                    ...
                                    <tr>
                                        <td align="center"><b style="
                                        font-size: 19px; 
                                        font-family:  merriweather, serif;"> No. Seleksi : <?php if (isset($datsel->id_seleksi)) {
                                           echo $datsel->id_seleksi;
                                        }else {
                                           echo "Belum Ada";
                                        } ?> </b></td>
                                    </tr>
                        ...
                        <br><br>
                        <div align="center">
                            <?php if (isset($datsel->id_seleksi)) { ?>
