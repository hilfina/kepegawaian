          ...
          <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
              <ul class="breadcome-menu">
                ...
                <li><a href="#">Tambah Data Pendidikan</a> 
                  <span class="bread-slash">/</span>
                </li>
              </ul>
            </div>
    ...
    <div class="row">
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="sparkline13-list">
          ...
          <form action="<?php echo site_url(); ?>/admin/addPendidikan/" enctype="multipart/form-data" method="post">
            <div class="sparkline12-graph">
              ...
              <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                        <div class="input-mark-inner">
                            <input type="text" class="form-control" name="jurusan" placeholder="Cth:S1 Keperawatan">
                        </div>
                    </div>
                </div>
                <div class="row">
                  ...
                  <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                    <div class="input-mark-inner">
                      <div class="file-upload-inner ts-forms">
                        ...
                        <font size="2">Format dokumen harus dalam bentuk png/jpg. Ukuran file maksimal adalah 2 mb </font>
                      </div>
                    </div>
                  </div>
                </div>
