    ...
    <div class="row">
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="container-fluid" style="padding-right: 10%; padding-left: 10%">
          <form action="<?php echo site_url();?>/adminjenStatus/add?>" enctype="multipart/form-data" method="POST">
          ...
          <tr>
            ...
            <td style="height: 50px">
              <div class="col-lg-12">
                <input name="id_status" type="text" class="form-control" placeholder="Jenis Status Karyawan...">
                <input name="id" type="hidden" class="form-control" value="<?php echo $max->max; ?>">
              </div>
            </td>
          </tr>
          <tr>
            ...
            <td style="height: 50px">
              <div class="col-lg-12">
                <input name="kuota_cuti" type="text" class="form-control" placeholder="Kuota cuti untuk status tersebut...">
              </div>
            </td>
          </tr>
        </table>
