                ...
                <div class="sparkline12-list mt-b-30">
                    ...
                    <br>
                        <div class="main-sparkline12-hd">
                            <span><h4 align="center">EDIT DATA DIKLAT KARYAWAN</h4></span>
                        </div>
                    </div>
                    <br>
                    <?php foreach ($array as $key) { ?>
                    <form action="<?php echo site_url();?>/adminDiklat/edit/<?php echo $key->id_diklat ; ?>" enctype="multipart/form-data" method="post">
                    <?php } ?>
                        ...
                        <div class="input-knob-dial-wrap">
                            <div class="row">
                                ...
                                <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                    <div class="input-mark-inner">
                                        <input type="text" class="form-control" name="nomor_sertif" value="<?php echo $key->nomor_sertif ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                    <div class="input-mark-inner">
                                        <input type="text" class="form-control" name="nama_diklat" value="<?php echo $key->nama_diklat ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                    <div class="input-mark-inner">
                                        <input type="text" class="form-control" name="jenis_diklat" value="<?php echo $key->jenis_diklat ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                              <div class="date-picker-inner">
                                ...
                                <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                    <div class="input-daterange input-group" id="datepicker">
                                        <input type="text" class="form-control" name="jam" value="<?php echo $key->jam ?>"><p></p>
                                    </div>
                                </div>
                              </div>
                            </div>
                            <div class="row">
                              <div class="date-picker-inner">
                                ...
                                <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                    <div class="input-daterange input-group" id="datepicker">
                                        <input type="text" class="form-control" name="tahun" value="<?php echo $key->tahun ?>">
                                    </div>
                                </div>
                              </div>
                            </div>
