          ...
          <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
              <ul class="breadcome-menu">
                ...
                <li><a href="#">Tambah Data Kontrak</a> 
                </li>
              </ul>
            </div>
          </div>
    ...
    <div class="row">
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="sparkline13-list">
          ...
          <div class="sparkline13-hd">
              <div class="main-sparkline13-hd" align="center">
                <h1> Tambah Data Kontrak Karyawan</h1><br>
              </div>
          </div>
        ...
        <div class="container-fluid" style="padding-right: 10%; padding-left: 10%">
          <form action="<?php echo site_url();?>/adminKontrak/addKontrak/" enctype="multipart/form-data" method="POST">
          <table width="100%">
          <tr>
          ...
          <tr>
            <td><label form-control-label>Gaji</label></td>
            <td style="height: 50px">
              <div class="col-lg-12">
                <input name="gaji" type="text" class="form-control" placeholder="Gaji yang Tertera pada MOU">
              </div>
            </td>
          </tr>
          <tr>
