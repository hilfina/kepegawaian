    ...
    <div class="row">
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <?php foreach ($array as $key) { ?>
          <form action="<?php echo site_url();?>/adminSekolah/edit/<?php echo $key->id?>" enctype="multipart/form-data" method="POST">
          <table width="100%">
          <tr>
          ...
          <tr>
            ...
            <td style="height: 50px">
              <div class="col-lg-12">
                <input name="beasiswa" type="text" class="form-control" value="<?php echo $key->beasiswa ?>">
              </div>
            </td>
          </tr>
          <tr>
