                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <ul class="breadcome-menu">
                                    <li><a href="#">Data Pelatihan</a> <span class="bread-slash">/</span>
                                    </li>
                ...
                <div class="sparkline12-list mt-b-30">
                    ...
                    <br>
                        <div class="main-sparkline12-hd">
                            <span><h4 align="center">Upload Data Pelatihan </h4></span>
                        </div>
                    </div>
                    <br>
                    <div class="row">
                    ...
                    <form action="<?=site_url(); ?>/adminpelatihan/impor/" enctype="multipart/form-data" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                    <div class="input-mark-inner">
                                        ...
                                        <font size="2">Format dokumen harus dalam bentuk .xls / .xlxs, Apabila ada data yang memang kosong isi dengan angka 0</font>
                                    </div>
                                </div>
                            </div>
                            <br>
