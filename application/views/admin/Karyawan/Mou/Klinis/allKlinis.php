          ...
          <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
              <ul class="breadcome-menu">
                ...
                <li><span class="bread-blod">Data Klinis Karyawan</span>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div class="col-lg-6">
            <div class="sparkline13-hd">
              <div class="main-sparkline13-hd">
                <h1>Data <span class="table-project-n">Klinis Karyawan</span></h1>
              </div>
            </div>
          </div>
          <div class="col-lg-6">
            <div class="sparkline13-hd">
              <div class="main-sparkline13-hd">
                <div align="right">
                <a href="<?php echo site_url('adminKlinis/loadimpor')?>">
                  <button class="btn btn-primary waves-effect waves-light mg-b-15">Upload Data</button>
                </a>
                <a href="<?php echo site_url('adminKlinis/addKlinis')?>">
                ...
                <?php foreach ($array as $key) { ?>
                  <tr>
                    ...
                    <td align="center">
                      ...
                      <a href="<?php echo site_url(); echo "/adminKlinis/del/"; echo $key->id;?>" onclick="return confirm('Apakah anda yakin ingin menghapus data ini?')">
