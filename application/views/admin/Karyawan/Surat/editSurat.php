        ...
        <?php foreach ($data as $key) { ?>
          ...
          <tr>
            ...
            <td style="height: 50px">
              ...
              <div class="input-daterange input-group" id="datepicker">
                <input name="tgl_mulai" type="text" class="form-control" value="<?php echo date('m/d/Y', strtotime($key->tgl_mulai)); ?>">
              </div>
              </div>
              </div>
            </td>
          ...
          <tr>
            ...
            <td style="height: 50px">
              ...
              <div class="form-group data-custon-pick data-custom-mg" id="data_5">
              <div class="input-daterange input-group" id="datepicker">
                <input name="tgl_akhir" type="text" class="form-control" value="<?php echo date('m/d/Y', strtotime($key->tgl_akhir)); ?>">
              </div>
              </div>
              </div>
            </td>
