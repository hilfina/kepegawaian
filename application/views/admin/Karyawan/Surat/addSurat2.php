    ...
    <div class="row">
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="sparkline13-list">
          ...
          <form action="<?php echo site_url(); ?>/adminNotifikasi/addSurat/<?php echo $karyawan->nik."/".$karyawan->nik ?>" enctype="multipart/form-data" method="post">
