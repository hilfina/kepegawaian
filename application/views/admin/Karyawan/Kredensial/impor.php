                ...
                <div class="sparkline12-list mt-b-30">
                    ...
                    <br>
                        <div class="main-sparkline12-hd">
                            <span><h4 align="center">Upload Data Kredensial </h4></span>
                        </div>
                    </div>
                    <br>
                    <div class="row">
                                ...
                                <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                    <a href="<?php echo base_url().'Assets/format/kredensial.xlsx' ?>" download>
                                        <button class="btn btn-default waves-effect" class='submit'><i class="fa fa-download" aria-hidden="true"></i> Unduh Format</button>
                                    </a>
                                </div>
                            </div>
                    <form action="<?=site_url(); ?>/adminKew/impor/" enctype="multipart/form-data" method="post">
