...
class Mdl_karyawan extends CI_Model
{
    ...
    public function getaDiklat(){//untuk menampilkan data diklat di admin
        $query = $this->db->query("SELECT k.id_karyawan, k.nik, k.nama, k.id_profesi, k.id_status, sum(d.jam) as jam from diklat as d INNER JOIN karyawan as k on k.id_karyawan=d.id_karyawan GROUP by d.id_karyawan");
        return $query->result();
    }
